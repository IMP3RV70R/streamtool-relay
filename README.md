...
**Pre-launch.** A signed [installation preview](https://github.com/IMP3RV70R/streamtool-relay/releases/tag/0.1.0-candidate.20260918.4) is available
for clean Debian 13 / Ubuntu 24.04 servers with public IP and root SSH. Download
`streamtool-relay-0.3.4-preview.apk`, choose “Настроить” and enter the SSH address
